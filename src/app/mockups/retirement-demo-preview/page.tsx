export default function RetirementDemoPreviewMockup() {
  return (
    <div
      className="relative w-full overflow-hidden bg-gradient-to-br from-[#E8DFF5] to-[#D1C4E9]"
      style={{
        aspectRatio: '16/9',
        maxWidth: '100vw',
        maxHeight: '100vh',
        ...
        <div className="w-full max-w-4xl bg-white rounded-2xl shadow-2xl overflow-hidden">
          ...
          <div className="bg-[#FFF8F2] p-8">
            ...
            <div className="text-center">
              ...
              <p className="text-lg text-[#6B5B52] mb-3">
                30 Years of Leadership & Impact
              </p>
              <p className="text-sm text-[#6B5B52] mb-4">
                "A career defined by integrity, empathy, and excellence"
              </p>
            ...
            <div className="mt-6 bg-white rounded-xl p-4 shadow-sm">
              <div className="flex items-center gap-3 mb-3">
                ...
                <div>
                  <p className="font-semibold text-[#2B1E18] text-sm">Jennifer S.</p>
                  <p className="text-xs text-[#6B5B52]">Dec 20, 2024</p>
                </div>
              </div>
              <p className="text-sm text-[#4A372F] leading-relaxed">
                Your leadership shaped not just our projects, but our careers. You taught us to lead with empathy...
              </p>
            </div>
          </div>
        </div>
